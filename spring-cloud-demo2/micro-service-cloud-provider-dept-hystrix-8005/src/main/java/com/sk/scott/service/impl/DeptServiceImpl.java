...
public class DeptServiceImpl implements DeptService {
    ...
    @HystrixCommand(commandProperties = {
            ...
            @HystrixProperty(name = "metrics.rollingStats.timeInMilliseconds",value = "10000"),//统计时间窗口
            @HystrixProperty(name="circuitBreaker.requestVolumeThreshold",value = "10"),//统计时间窗内请求次数
            @HystrixProperty(name = "circuitBreaker.sleepWindowInMilliseconds",value = "10000"),//休眠时间窗口期
            @HystrixProperty(name = "circuitBreaker.errorThresholdPercentage",value = "60"),//在统计以内，请求失败率达到60%时进入熔断状态
    ...
    public String deptCircuitBreaker(Integer id) {
        ...
        String serialNum = String.valueOf(System.currentTimeMillis());
